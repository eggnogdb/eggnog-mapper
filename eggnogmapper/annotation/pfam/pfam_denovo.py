...
##
def pfam_align_denovo(all_annotations, queries_fasta, translate, cpu, temp_dir, pfam_file):
    aligned_pfams = None
    ...
    pfam_args, infile = get_pfam_args(cpu, fasta_file.name, translate, temp_dir)
